...
<body>
   ...
   <nav>
        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Комод с коричневыми деревянными ящиками и серым корпусом</h3>
                    <p>Придайте вашему интерьеру элегантный и современный вид с нашим комодом, который сочетает в себе стильный серый корпус и теплые коричневые деревянные ящики. Этот комод станет не только функциональным элементом хранения, но и стильным акцентом в вашем доме.</p>
                </div>
                <div class="content-button">
                    <p class="price">23 990 рублей</p>
    ...
    $product_id = 17; // Замените на реальный ID товара, если он не фиксированный
