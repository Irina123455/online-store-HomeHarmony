...
<body>
   ...
   <nav>
        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Кресло офисное с серой сетчатой спинкой и бежевым сиденьем</h3>
    ...
    $product_id = 38; // Замените на реальный ID товара, если он не фиксированный
