...
<body>
   ...
   <nav>
        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Мягкие бежевые стулья с деревянными ножками</h3>
                    <p>Ощутите комфорт и добавьте нотку элегантности в свой дом с этими мягкими бежевыми стульями. Нежная обивка приятного оттенка гармонично сочетается с прочными деревянными ножками, создавая стильный и уютный образ. Идеальны для обеденной зоны, кухни или гостиной.</p>
                </div>
                <div class="content-button">
                    <p class="price">17 990 рублей</p>
    ...
    $product_id = 24; // Замените на реальный ID товара, если он не фиксированный
