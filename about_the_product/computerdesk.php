...
<body>
   ...
   <nav>
        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Компьютерный стол с бежевой столешницей и полкой для клавиатуры</h3>
                    <p>Оптимизируйте свое рабочее пространство с помощью этого функционального компьютерного стола. Бежевая столешница создает атмосферу тепла и уюта, а выдвижная полка для клавиатуры обеспечивает правильное положение рук и комфортную работу.</p>
            </div>
    ...
    $product_id = 37; // Замените на реальный ID товара, если он не фиксированный
