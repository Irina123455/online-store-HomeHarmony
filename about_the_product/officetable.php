        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Тумбочка с бежевыми ящиками и серым корпусом для офиса</h3>
                    <p>Практичная тумбочка с бежевыми ящиками и серым корпусом. Идеальное решение для организации хранения документов и канцелярии в офисе.</p>
            </div>
...
<div class="reviews">
    ...
    $product_id = 40; // Замените на реальный ID товара, если он не фиксированный
