...
<body>
   ...
   <nav>
        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Мягкое бежевое кресло с акцентами светло-бежевого</h3>
                    <p>Погрузитесь в мир комфорта и стиля с нашим мягким бежевым креслом, которое станет изюминкой вашего интерьера. Это кресло не только привлекает внимание своим элегантным дизайном, но и обеспечивает непревзойденное удобство для отдыха и расслабления.</p>
                </div>
                <div class="content-button">
                    <p class="price">22 990 рублей</p>
    ...
    $product_id = 7; // Замените на реальный ID товара, если он не фиксированный
