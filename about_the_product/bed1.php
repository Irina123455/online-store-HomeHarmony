...
<body>
   ...
   <nav>
        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Бежевая кровать с мягким изголовьем</h3>
                    <p>Создайте атмосферу уюта и комфорта в вашей спальне с нашей бежевая кровать с мягким изголовьем. Этот стильный и элегантный предмет мебели станет не только центральным элементом вашего интерьера, но и обеспечит вам комфортный и restful сон.</p>
</p>
                </div>
                <div class="content-button">
                    <p class="price">33 990 рублей</p>
    ...
    $product_id = 13; // Замените на реальный ID товара, если он не фиксированный
