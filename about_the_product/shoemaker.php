...
<body>
   ...
   <nav>
        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Обувница с серыми дверцами и бежевым корпусом</h3>
                    <p>Стильная обувница с серыми дверцами и бежевым корпусом. Эффективное решение для организации хранения обуви в прихожей.</p>
            </div>
    ...
    $product_id = 28; // Замените на реальный ID товара, если он не фиксированный
