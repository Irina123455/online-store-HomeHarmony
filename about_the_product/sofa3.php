...
<body>
   ...
   <nav>
        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Модульный серый диван в стиле минимализм</h3>
                    <p>Создайте уют и стиль в вашем интерьере с нашим модульным серым диваном в стиле минимализм. Этот диван идеально подходит для современных интерьеров, сочетая элегантный дизайн и функциональность.</p>
                </div>
    ...
    $product_id = 5; // Замените на реальный ID товара, если он не фиксированный
