...
<body>
   ...
   <nav>
        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Стеллаж офисный с коричневыми полками и серым металлическим каркасом</h3>
                    <p>Обеспечьте себе комфорт и поддержку во время работы с этим эргономичным офисным креслом. Дышащая сетчатая спинка серого цвета и мягкое бежевое сиденье создают оптимальные условия для продуктивной работы.</p>
            </div>
    ...
    $product_id = 39; // Замените на реальный ID товара, если он не фиксированный
