...
<body>
   ...
   <nav>
        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Барный стол с коричневой столешницей и металлическими ножками</h3>
                    <p>Этот барный стол с коричневой столешницей и металлическими ножками — идеальное решение для создания стильного и современного пространства в вашем доме или заведении. </p>
                </div>
    ...
    $product_id = 23; // Замените на реальный ID товара, если он не фиксированный
