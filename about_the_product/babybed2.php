...
<body>
   ...
   <nav>
        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Двухъярусная кровать с серым каркасом и бежевыми ступенями</h3>
                    <p>Двухъярусная кровать с серым каркасом и бежевыми ступенями. Стильное и функциональное решение для детской комнаты.</p>
            </div>
    ...
    $product_id = 32; // Замените на реальный ID товара, если он не фиксированный
