...
<body>
   ...
   <nav>
        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Вешалка с бежевой основой и коричневыми крючками</h3>
                    <p>Добавьте функциональности и стиля в вашу прихожую с этой вешалкой, сочетающей в себе нежную бежевую основу и теплые коричневые крючки. Идеальное решение для организации хранения верхней одежды и аксессуаров.</p>
            </div>
                    <div class="content-button">
                    <p class="price">2990 рублей</p>
    ...
    $product_id = 27; // Замените на реальный ID товара, если он не фиксированный
