...
<body>
   ...
   <nav>
        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Серые стенки и стеллажи в стиле лофт</h3>
                    <p> Идеальное решение для создания современного и функционального интерьера. Минималистичный дизайн и индустриальная эстетика добавят вашему дому характера.</p>
                </div>
    ...
    $product_id = 4; // Замените на реальный ID товара, если он не фиксированный
