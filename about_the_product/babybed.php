...
<body>
   ...
   <nav>
        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Бежевая кроватка для новорожденного с деревянными элементами</h3>
                    <p>Уютная бежевая кроватка для новорожденного с деревянными элементами. Обеспечит комфортный и безопасный сон вашему малышу.</p>
            </div>
    ...
    $product_id = 31; // Замените на реальный ID товара, если он не фиксированный
