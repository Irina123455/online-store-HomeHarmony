        ...
        data-image="../media/TV-stand.png">
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Бежевая ТВ-тумба в скандинавском стиле</h3>
                    <p> Бежевая ТВ-тумба в скандинавском стиле - это элегантное и функциональное решение для вашей гостиной. Изготовлена из качественных материалов в светлых тонах, характерных для скандинавского дизайна. Идеально подходит для размещения телевизора и хранения медиа-устройств.</p>
                </div>
                <div class="content-button">
                    <p class="price">14 990 рублей</p>
...
<div class="reviews">
    ...
    $product_id = 3; // Замените на реальный ID товара, если он не фиксированный
