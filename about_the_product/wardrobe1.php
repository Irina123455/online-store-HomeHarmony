...
<body>
   ...
   <nav>
        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Серый шкаф с бежевыми дверцами в минималистичном стиле</h3>
                    <p>Добавьте в ваш интерьер нотку современности и стиля с нашим серым шкафом с бежевыми дверцами, выполненным в минималистичном дизайне. Этот шкаф станет идеальным решением для хранения вещей и украсит любое помещение, будь то спальня, гостиная или прихожая.</p>
                </div>
                <div class="content-button">
                    <p class="price">29 990 рублей</p>
    ...
    $product_id = 18; // Замените на реальный ID товара, если он не фиксированный
