...
<body>
   ...
   <nav>
        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Бежевый диван-кровать с деревянными подлокотниками</h3>
                    <p>Добавьте уют и элегантность в ваш интерьер с нашим бежевым диваном-кроватью, который идеально сочетает в себе стиль и функциональность. Этот диван станет не только комфортным местом для отдыха, но и практичным решением для небольших пространств.</p>
                </div>
    ...
    $product_id = 6; // Замените на реальный ID товара, если он не фиксированный
