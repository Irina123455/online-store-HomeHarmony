...
<body>
   ...
   <nav>
     ...
     <div class="product-detail-wrapper">
       ...
       <div class="content">
           <div class="content-text">
               <h3>Угловой коричневый диван в стиле модерн</h3>
               <p>Этот угловой диван в стиле модерн станет центральным элементом вашей гостиной. Его глубокий коричневый оттенок создает атмосферу тепла и уюта, а угловая конструкция обеспечивает максимальное количество посадочных мест. Диван выполнен в современном стиле, отличается четкими линиями и минималистичным дизайном. Прочный каркас и качественная обивка гарантируют долговечность и комфорт.</p>
           </div>
           <div class="content-button">
               <p class="price">36 990 рублей</p>
               <button class="add-to-cart-btn" type="submit">В корзину</button> <!-- Исправлен класс кнопки -->
           </div>
       </div>
   </div>
    ...
    $product_id = 2; // Замените на реальный ID товара, если он не фиксированный
