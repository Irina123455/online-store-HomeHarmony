...
<body>
   ...
   <nav>
        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Стол письменный с коричневой столешницей и металлическими серыми ножками</h3>
                    <p>Создайте комфортное и функциональное рабочее место с этим письменным столом, сочетающим в себе тепло коричневой столешницы и современный серый металл ножек. Идеально подходит для дома и офиса.</p>
            </div>
                    <div class="content-button">
                    <p class="price">11 990 рублей</p>
    ...
    $product_id = 36; // Замените на реальный ID товара, если он не фиксированный
