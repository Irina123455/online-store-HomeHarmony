...
<body>
   ...
   <nav>
        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Серый шкаф с бежевыми ящиками для детской одежды</h3>
                    <p>Организуйте пространство в детской комнате с помощью этого шкафа, сочетающего в себе современный серый корпус и уютные бежевые ящики. Идеальное решение для хранения одежды, игрушек и других детских вещей.</p>
            </div>
    ...
    $product_id = 34; // Замените на реальный ID товара, если он не фиксированный
