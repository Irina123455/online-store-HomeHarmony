   ...
   <nav>
     ...
     <div class="product-detail-wrapper">
        ...
        <div class="container" data-id="1" 
            ...
            data-price="27990"
            data-image="../media/sofa1.png">
            <img src="../media/sofa1.png" alt="Прямой бежевый диван в скандинавском стиле">
            <div class="content">
                <div class="content-text">
                    <h3>Прямой бежевый диван в скандинавском стиле</h3>
                    <p>Светлый бежевый диван в скандинавском стиле – это воплощение простоты и уюта. Мягкая, приятная на ощупь ткань, чистые линии и минималистичный дизайн создают светлую, воздушную атмосферу, располагающую к отдыху.</p>
                </div>
                <div class="content-button">
                    <p class="price">27 990 рублей</p>
    ...
    $product_id = 1; // Замените на реальный ID товара, если он не фиксированный
