...
<body>
   ...
   <nav>
        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Серый кресло-мешок в стиле лофт</h3>
                    <p>Добавьте уникальности и комфорта в ваше пространство с нашим серым креслом-мешком в стиле лофт. Это стильное и функциональное решение идеально подходит для современных интерьеров, сочетая в себе непринужденность и элегантность.</p>
                </div>
                <div class="content-button">
                    <p class="price">19 990 рублей</p>
    ...
    $product_id = 9; // Замените на реальный ID товара, если он не фиксированный
