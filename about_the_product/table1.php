        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Коричневый журнальный столик в стиле минимализм</h3>
                    <p>Привнесите элегантность и функциональность в ваше пространство с нашим коричневым журнальным столиком в стиле минимализм. Этот столик станет идеальным акцентом для вашего интерьера, сочетая простоту форм и высокое качество материалов.</p>
                </div>
...
<div class="reviews">
    ...
    $product_id = 10; // Замените на реальный ID товара, если он не фиксированный
