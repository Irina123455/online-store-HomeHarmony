...
<body>
   ...
   <nav>
     ...
     <div class="product-detail-wrapper">
        ...
        <div class="container"
                      data-id="29"
                      data-name="Зеркало в коричневой деревянной раме"
                      data-price="12990"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Зеркало в коричневой деревянной раме</h3>
                    <p>Элегантное зеркало в коричневой деревянной раме. Стильный акцент для любого интерьера.</p>
            </div>
...
<div class="reviews">
    ...
    $product_id = 29; // Замените на реальный ID товара, если он не фиксированный
