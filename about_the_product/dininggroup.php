...
<body>
   ...
   <nav>
        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Обеденная группа с бежевым столом и серыми стульями</h3>
                    <p>Стильная обеденная группа: бежевый стол и серые стулья. Идеальное решение для современной кухни или столовой.</p>
            </div>
                    <div class="content-button">
                    <p class="price">28 990 рублей</p>
    ...
    $product_id = 26; // Замените на реальный ID товара, если он не фиксированный
