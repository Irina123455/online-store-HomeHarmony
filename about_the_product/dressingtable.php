        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Бежевый туалетный столик с зеркалом и мягким стулом</h3>
                    <p>Создайте атмосферу уюта и стиля в вашем доме с нашим элегантным бежевым туалетным столиком, комплектом с зеркалом и мягким стулом. Этот набор станет идеальным дополнением вашей спальни или ванной комнаты, предоставляя вам удобное место для ухода за собой и хранения косметики.</p>
                </div>
...
<div class="reviews">
    ...
    $product_id = 19; // Замените на реальный ID товара, если он не фиксированный
