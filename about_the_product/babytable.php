...
<body>
   ...
   <nav>
        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Бежевый стол с серым стулом для ребенка</h3>
                    <p>Создайте комфортное и функциональное рабочее место для вашего ребенка с этим комплектом, включающим бежевый стол и серый стул.</p>
            </div>
    ...
    $product_id = 33; // Замените на реальный ID товара, если он не фиксированный
