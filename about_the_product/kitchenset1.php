...
<body>
   ...
   <nav>
        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Кухонный гарнитур с бежевыми фасадами и коричневой столешницей</h3>
                    <p>Создайте уютную и стильную атмосферу на вашей кухне с нашим элегантным кухонным гарнитуром, который сочетает в себе бежевые фасады и коричневую столешницу. Этот гарнитур не только функционален, но и станет настоящим украшением вашего интерьера.</p>
                </div>
                <div class="content-button">
                    <p class="price">45 990 рублей</p>
    ...
    $product_id = 20; // Замените на реальный ID товара, если он не фиксированный
