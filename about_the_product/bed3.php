...
<body>
   ...
   <nav>
        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Серая кровать с подъемным механизмом и местом для хранения</h3>
                    <p>Добавьте стиль и функциональность в ваше пространство с нашей бежевай тумбочкой с ящиками. Эта элегантная тумбочка станет идеальным дополнением к вашей спальне, гостиной или прихожей, обеспечивая удобное место для хранения и организации.</p>
                </div>
                <div class="content-button">
                    <p class="price">37 990 рублей</p>
    ...
    $product_id = 15; // Замените на реальный ID товара, если он не фиксированный
