        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Обеденный стол с бежевой столешницей и серыми ножками</h3>
                    <p>Обеденный стол с бежевой столешницей и серыми ножками — это стильный и функциональный элемент интерьера, который станет центром вашего обеденного пространства. </p>
                </div>
                <div class="content-button">
                    <p class="price">15 990 рублей</p>
...
<div class="reviews">
    ...
    $product_id = 22; // Замените на реальный ID товара, если он не фиксированный
