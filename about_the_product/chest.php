...
<body>
   ...
   <nav>
        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Бежевая тумбочка с ящиками</h3>
                    <p>Создайте идеальное пространство для отдыха и хранения с нашей стильной серой кроватью, оснащенной подъемным механизмом. Эта кровать сочетает в себе современный дизайн, функциональность и комфорт, что делает её отличным выбором для любой спальни.</p>
                </div>
    ...
    $product_id = 16; // Замените на реальный ID товара, если он не фиксированный
