...
<body>
   ...
   <nav>
        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Коричневое кресло-качалка с текстильной обивкой</h3>
                    <p>Погрузитесь в атмосферу уюта и спокойствия с нашим коричневым креслом-качалкой, которое станет идеальным местом для отдыха и расслабления. Это кресло сочетает в себе классический дизайн и современный комфорт, что делает его отличным дополнением к любому интерьеру.</p>
                </div>
                <div class="content-button">
                    <p class="price">26 990 рублей</p>
    ...
    $product_id = 8; // Замените на реальный ID товара, если он не фиксированный
