   ...
   <nav>
     ...
     <div class="product-detail-wrapper">
        ...
        <div class="container"
                    ...
                    <img src="../media/console.png" alt="Коричневая консоль с деревянной столешницей и металлическими ножкамиБежевый пуф с текстильной обивкой">
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Коричневая консоль с деревянной столешницей и металлическими ножками</h3>
                    <p>Добавьте элегантности и функциональности вашему интерьеру с нашей коричневой консолью, выполненной с деревянной столешницей и металлическими ножками. Этот стильный предмет мебели идеально подходит для прихожей, гостиной или любого другого пространства, где требуется дополнительная поверхность.
</p>
                </div>
                <div class="content-button">
                    <p class="price">13 990 рублей</p>
...
<div class="reviews">
    ...
    $product_id = 12; // Замените на реальный ID товара, если он не фиксированный
