        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Кухонный гарнитур на заказ с использованием серого, коричневого и бежевого цветов</h3>
                    <p>Создайте уникальную кухню своей мечты с нашим кухонным гарнитуром на заказ, выполненным в стильном сочетании серого, коричневого и бежевого цветов. Этот гарнитур не только отвечает современным требованиям дизайна, но и идеально впишется в любой интерьер, добавляя ему элегантности и уюта.</p>
                </div>
                <div class="content-button">
                    <p class="price">49 990 рублей</p>
...
<div class="reviews">
    ...
    $product_id = 21; // Замените на реальный ID товара, если он не фиксированный
