...
<body>
   ...
   <nav>
        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Барные серые стулья с регулируемой высотой</h3>
                    <p>Идеальное сочетание стиля и удобства: барные стулья в элегантном сером цвете с регулируемой высотой. Легко адаптируются под любую барную стойку или стол, обеспечивая комфорт и поддержку. Прочная конструкция гарантирует долговечность.</p>
                </div>
    ...
    $product_id = 25; // Замените на реальный ID товара, если он не фиксированный
