...
<body>
   ...
   <nav>
        ...
        <div class="container"
            ...
            <div class="content">
                <div class="content-text"> <!-- Исправлено content-tet на content-text -->
                    <h3>Бежевый комод с серыми ручками в детской</h3>
                    <p>Стильный бежевый комод с серыми ручками для детской. Практичное и элегантное решение для хранения вещей вашего ребенка.</p>
            </div>
    ...
    $product_id = 35; // Замените на реальный ID товара, если он не фиксированный
